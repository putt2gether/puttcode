...
$first_team_id=$teamdata['first_team_id'];
    $golfdatta['teamdata']=(isset($teamdata['current_standing']) && count($teamdata['current_standing'])>0)?$teamdata['current_standing']:array();
}
...
$golfdattaspot1 = $this->db->FetchRow($queryString);
$k["is_temporary"] = (isset($golfdattaspot1["hole_num_".$hole_number]) && $golfdattaspot1["hole_num_".$hole_number]>0) ? 0 : 1;
//$k["is_temporary"] = 0;
}

if((isset($golfdattaspot1["hole_num_".$hole_number]) && $golfdattaspot1["hole_num_".$hole_number]>0)) {
	$golfdattaspot = $golfdattaspot1;
}
...
//print_r($score_a);print_r($score_b);print_r($score_c);die;
