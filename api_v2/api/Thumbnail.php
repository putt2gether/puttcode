...
class Thumbnail {
 ...
 function WriteWatermark($watermarktext=""){
  ...
  $black = imagecolorallocate($imagewithwatermark, 255,255,255);
  ...
  */
  ...
  imagettftext($imagewithwatermark, $font_size, 0, 12, 20, $black, $font, $watermarktext);
