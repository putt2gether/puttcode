...
$ps = _DB_PASSWD_;
$dbu = _DB_USER_;
//echo $database_server_object . " ".$ps. " ".$dbu;die;
			try 
			{
				$this->databse_object_instance = new PDO($database_server_object, $dbu, $ps, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8",PDO::ATTR_EMULATE_PREPARES => true)); 
...
//$this->databse_object_instance = new PDO("mysql:host=localhost;dbname=insta_partyz_db;", "insta", "Ff@45722");
				...
				$this->databse_object_instance->setAttribute(PDO::ATTR_EMULATE_PREPARES, true);
