...
function sendEmail($body='',$email='',$fullname='',$subject='') {
	...
	$signature = '<br/>From,<br/>Instapartyz<br/>http://'.$_SERVER['HTTP_HOST'];
...
function SendAlert($sender_id,$receiver_id,$subject,$message,$event_id=0){
	...
	if($sender_id!="" && $receiver_id!="" && $subject!="" && $message!=""){
		...
		$ip_address = $_SERVER['REMOTE_ADDR'];
                        ...
                        $sqlQuery .= " '".$event_id."',";
						$sqlQuery .= " '".$type."',";
						$sqlQuery .= " '".mysql_real_escape_string($subject)."',";
                        $sqlQuery .= " '".mysql_real_escape_string($message)."',";
                        $sqlQuery .= " now(),";
                        $sqlQuery .= " '".$ip_address."'";
                        $sqlQuery .= " )";
...
function getEventTee($tee){
	...
	//print_r($teeVal);
	$menArr=isset($teeVal['men'])?getTeeName($teeVal['men'],1):array();
	$laArr=isset($teeVal['ladies'])?getTeeName($teeVal['ladies'],1):array();
	$juArr=isset($teeVal['junior'])?getTeeName($teeVal['junior'],1):array();
	...
	return array('Men'=>$men,'MenColor'=>$mencolor,'Ladies'=>$ladies,'LadiesColor'=>$ladiescolor,'Junior'=>$junior,'JuniorColor'=>$juniorcolor);
}
...
<table id="Table_01" width="593" height="369" border="0" cellpadding="0" cellspacing="0" style="margin:20px auto;border:4px solid #325604;">
	<tr>
		<td rowspan="6">
		...
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="39" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>
	<tr>
		<td colspan="3"><a href="#"><img src="'.__BASE_URI__.'newsletter/newsletter_04.png" width="320" height="115" alt="" style="float:left;margin:0;padding:0;outline:none;"></a></td>
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="115" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>
	<tr>
		<td colspan="3" style="font-family:arial;font-size:12px;padding:10px 0;padding-left:26px;color:#000;line-height:18px;">'.$message.'</td>
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="98" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>
	<!--<tr>
		<td rowspan="2"><img src="'.__BASE_URI__.'newsletter/newsletter_06.png" width="25" height="63" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
		<td rowspan="2"><a href="#"><img src="'.__BASE_URI__.'newsletter/newsletter_07.png" width="192" height="63" alt="" style="float:left;margin:0;padding:0;outline:none;"></a></td>
		<td rowspan="2"><img src="'.__BASE_URI__.'newsletter/newsletter_08.png" width="103" height="63" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="62" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>
	<tr>
		<td rowspan="2"><img src="'.__BASE_URI__.'newsletter/newsletter_09.png" width="130" height="55" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
		<td rowspan="2"><a href="#"><img src="'.__BASE_URI__.'newsletter/newsletter_10.png" width="141" height="55" alt="" style="float:left;margin:0;padding:0;outline:none;"></a></td>
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="1" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>-->
	<tr>
		<td colspan="3"><img src="'.__BASE_URI__.'newsletter/newsletter_11.png" width="320" height="54" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
		<td><img src="'.__BASE_URI__.'newsletter/spacer.gif" width="1" height="54" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
	</tr>
</table></body></html>';
...
<table id="Table_01" width="593" height="369" border="0" cellpadding="0" cellspacing="0" style="margin:20px auto;border:4px solid #3256;">
	<tr>
		<td rowspan="6">
			<img src="'.__BASE_URI__.'newsletter/newsletter_01.png" width="1" height="369" alt="" style="float:left;margin:0;padding:0;outline:none;"></td>
		<td colspan="3">
...
<div style='clear:both;'></div><br />";
			...
			foreach($emails as $a=>$b) {
				if(!in_array(trim($b),$all_emails)) {
					$ins_arr[]="('".$event_id."', '".mysql_real_escape_string(trim($b))."', '0', now(), now(), '".mysql_real_escape_string(trim($subject))."', '".mysql_real_escape_string(trim($msg))."')";
					$all_emails[] = trim($b);
				}
			}
			if(count($ins_arr)>0) {
...
function createUser($data){
	...
	$userValue = 0;
	$sqlQuery="insert into ".TABLE_GOLF_USERS." set user_name='".mysql_real_escape_string($emeilId)."',alternate_email_id='".mysql_real_escape_string($emeilId)."',is_new='1', 'full_name'='".$name."', 'display_name'='".$name."'";	
