...
class Mail
{
	...
	public $_port = "465";
	public $_username = "feedback@putt2gether.com";
	public $_password = "golf@1234";
	public $_to = "ashok@soms.in";
	public $_toName = "ashok";
	public $_from = "feedback@putt2gether.com";
	...
	public function Mail($to, $toName, $subject, $message,$isSmtp = true,$filepath=''){
		if(strpos($to,",")!==false) {
			$exp=explode(",",$to);
			$this->_to=$exp[0];
			unset($exp[0]);
